...
[Icons]
Name: "{group}\Animecaos"; Filename: "{app}\Animecaos.exe"; IconFilename: "{app}\icon.ico"
Name: "{group}\{cm:UninstallProgram,Animecaos}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\Animecaos"; Filename: "{app}\Animecaos.exe"; Tasks: desktopicon; IconFilename: "{app}\icon.ico"
